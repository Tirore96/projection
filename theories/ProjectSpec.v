...
From Proj Require Import Utils Syntax Elimination GlobalTree EndpointTree.
...
Let eqs := (EndpointTree.eqs, GlobalTree.eqs). 
...
Lemma Rolling_iff : forall g, Rolling g <-> Rolling (full_unf g). 
Proof. 
...
- punfold H1. inv H1;clear H1. 
  ...
  rewrite -Rolling_iff. apply/Unravelg2_Rol. pfold.  con. eauto. 
...
- punfold H1. inv H1. apply/Project_unfg. inv H3. 
  ...
  rewrite -Rolling_iff. apply/Unravelg2_Rol. pfold. con. con. 2 : eauto. eauto.
...
apply/paco2_mon. 
apply/GlobalTree.Rolling_iff. rewrite Rolling_iff. done. done. 
Qed. 
